...
export default function ThreeDModeling() {
    useSEO({
        title: '3D Modeling Services | B3D Designs',
        description: 'High-quality 3D modeling services for architectural visualization and design projects.',
    });
        ...
        <section className="pt-32 pb-24 min-h-screen bg-white">
            <div className="container mx-auto px-6 md:px-12">
                <div className="max-w-4xl mx-auto text-center mb-16">
                    ...
                    >
                        3D <span className="text-blue-600">Modeling</span>
                    </motion.h1>
                    <motion.p 
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                        Bring your concepts to life with meticulous 3D modeling. We create highly detailed, accurate geometries tailored to your exact specifications.
                    </motion.p>
                </div>
